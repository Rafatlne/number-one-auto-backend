...
def load_vars():
    ...
    # First check for ENV_FILE environment variable
    env_file = os.environ.get("ENV_FILE")
    
    # If ENV_FILE not set, look for .env in current and parent directories
    if not env_file:
        current_dir_env = Path(BASE_DIR.parent / '.env')
        parent_dir_env = Path(BASE_DIR.parent.parent / '.env')
        
        if current_dir_env.exists() and current_dir_env.is_file():
            env_file = str(current_dir_env)
        elif parent_dir_env.exists() and parent_dir_env.is_file():
            env_file = str(parent_dir_env)
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "conf.utils.DynamicPagination",
    ...
    "DEFAULT_FILTER_BACKENDS": [
        ...
        "api.filters.PrimaryKeyFilterBackend"
    ],
